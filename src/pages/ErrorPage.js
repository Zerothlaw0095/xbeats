...
const ErrorPage = () => {
    ...
    const footSocial = [
        ...
        { id: 2, icon: <FaTwitter />, url: "https://twitter.com/AkashPa46439625/" },
        { id: 3, icon: <FaInstagram />, url: "https://www.instagram.com/akash_04495/" },
        { id: 4, icon: <FaLinkedinIn />, url: "https://in.linkedin.com/in/akash-pathak-b9b4a8253/" }
    ];
    return (
        <>
